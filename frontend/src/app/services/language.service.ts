...
const DICTIONARY: Record<Language, Translations> = {
  pt: {
    ...
    about: {
      ...
      p1: 'Sou estagiário de tecnologia no FIT (Flextronics Instituto de Tecnologia) e estudante de Engenharia da Computação na FACENS. No meu dia a dia, escrevo código para resolver problemas reais e aplico na prática o que aprendo na faculdade.',
      p2: 'Meu foco principal é no ecossistema Java com Spring Boot para construção de APIs e serviços backend robustos. Também trabalho com TypeScript, React, Node.js, PostgreSQL, Docker e integração com microcontroladores ESP32 com C++.',
      card1Title: 'FACENS',
  ...
  en: {
    ...
    about: {
      ...
      p1: 'I am a Technology Intern at FIT (Flextronics Institute of Technology) and a Computer Engineering student at FACENS. Daily, I write code to solve real-world problems and put engineering concepts into practice.',
      p2: 'My main focus is the Java ecosystem with Spring Boot for building robust APIs and backend services. I also work with TypeScript, React, Node.js, PostgreSQL, Docker, and ESP32 IoT microcontrollers with C++.',
      card1Title: 'FACENS',
