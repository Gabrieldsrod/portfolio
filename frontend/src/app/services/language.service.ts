...
const DICTIONARY: Record<Language, Translations> = {
  pt: {
    ...
    about: {
      ...
      p2: 'Com atuação Fullstack e foco em desenvolvimento Backend e arquitetura de software, busco aprimoramento constante em ecossistemas Java (Spring Boot), Node.js, TypeScript e React, além de bancos de dados relacionais (PostgreSQL), conteinerização com Docker e soluções IoT com ESP32.',
      card1Title: 'FACENS',
  ...
  en: {
    ...
    hero: {
      ...
      summary: 'Computer Engineering student & Fullstack Developer with a primary focus on Backend. Passionate about software engineering, building APIs with Java & Spring Boot, reactive web applications, and IoT integrations.',
    ...
    about: {
      ...
      p2: 'Working as a Fullstack Developer focused on Backend engineering, I continuously expand my practical skills across Java (Spring Boot), Node.js, TypeScript, and React, alongside relational databases (PostgreSQL), Docker containerization, and ESP32 IoT integrations.',
      card1Title: 'FACENS',
